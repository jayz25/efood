...
export const TopNav = () => {
    return (
        <div className="fixed w-full max-w-full xl:max-w-screen-xl h-20 flex flex-col-reverse md:flex-row bg-gray-400 justify-between items-center z-50 rounded-bl-lg rounded-br-lg">
            ...
            <div className="flex flex-row items-center justify-self-center mr-4">
                ...
                <button className="p-1 md:p-2 text-sm md:text-lg rounded-md bg-gray-700 mr-2 text-white hover:text-black cursor-not-allowed hover:bg-white" onClick={() => signIn()}>
                    Log In
                </button>
